    ...
    <>
      ...
      <div className="flex flex-col lg:!flex-row justify-between gap-8 mb-4">
        ...
        {addOns.data.map((addOn) => {
          const features =
            ADD_ONS.find((prod) => prod.id === addOn.id)?.features || [];
          ...
          return (
            <PricingCard
              ...
              title={addOn.name}
              highlightTitle={"Add-Ons"}
              highlightDescription={
                "Add-Ons are additional features that you can add to your plan. If you have further question please, contact support@plura.com"
              }
              duration={"/ month"}
              features={features}
            />
