...
const AgencyIdPage: React.FC<AgencyIdPageProps> = async ({ params }) => {
  ...
  try {
            ...
            <div className="flex gap-4 flex-col xl:!flex-row">
              ...
              <Card className="flex-1 relative">
                <CardHeader>
                  ...
                  <CardTitle className="text-4xl">{subAccounts?.length || 0}</CardTitle>
                </CardHeader>
                <CardContent className="text-sm text-muted-foreground">
                  ...
                  <div className="flex flex-col w-full">
                    <div className="flex justify-between items-center">
                      <span className="text-muted-foreground text-sm">
                        Current: {subAccounts?.length || 0}
                      </span>
                      <span className="text-muted-foreground text-sm">
                        Goal: {agencyDetails.goal || 0}
                      </span>
                    </div>
                    <Progress
                      value={
                        ...
                        {sessions && sessions.length > 0 && (
                          <div className="flex flex-col">
                            ...
                            <div className="flex gap-2">
                              ...
                              {sessions.length - (totalClosedSessions?.length || 0)}
                            </div>
                          </div>
                        )}
    ...
    console.error("Error in AgencyIdPage:", error);
